...
export class GeminiInterviewAgent implements IInterviewAgent {
  ...
  #buildSystemInstruction(context: InterviewAgentContext, isFirstTurn: boolean): string {
    const lines = [
      ...
      'Always write replyText in English only. If the employee writes in Spanish or any other language, translate the meaning internally and answer in clear English. Never mirror the employee language.',
